...
describe('[Exercise 3] findLargestInteger', () => {
  test('[5] returns the largest number in an array of objects { integer: 2 }', () => {
    const input = [{ integer: 3}, { integer: 5}, { integer: 6}, { integer: 8}]
    const input2 = [{ integer: 69}, { integer: 7}, { integer: 65}, { integer: 8}]
    const input3 = [{ integer: 3}, { integer: 34}, { integer: 6}, { integer: 8}]
    actual = utils.findLargestInteger(input)
    actual2 = utils.findLargestInteger(input2)
    actual3 = utils.findLargestInteger(input3)
    expect(actual).toBe(8)
    expect(actual2).toBe(69)
    expect(actual3).toBe(34)
  })
})
